...
# global in_front, to_the_left, far_left, to_the_right, far_right, behind_you, center
# global window_near_door, window_on_left_wall, window_on_right_wall, window_on_front_wall
...
def room_format_print(in_front, to_the_left, far_left, to_the_right, far_right, behind_you, center,
...
def room_format_rdf(in_front, to_the_left, far_left, to_the_right, far_right, behind_you, center,
                      window_near_door, window_on_left_wall, window_on_right_wall, window_on_front_wall):
