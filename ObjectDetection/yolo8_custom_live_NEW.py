...
def main():
    global Current_object_list, last_detected_objects
    Current_object_list = []
    last_detected_objects = set()
...
##########################################
    ...
    #                 Current_object_list)  # Convert current detected objects list to a set for easy comparison
    #
    ...
    #             if (current_detected_objects != last_detected_objects or has_spatial_relationship_changed(
    #                     current_spatial_relationships, last_spatial_relationships)):
    #
    ...
    #                 Spatial_announcement = Check_the_spatial_relationship_of_current_objects(
    #                     current_spatial_relationships,
    ...
    #                     print(full_announcement)
    #                     # Start a new thread to speak the announcement
    #                     thread = threading.Thread(target=thread_function, args=(full_announcement,))
    #                     thread.start()
